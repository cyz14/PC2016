...
add wave -noupdate -label im_addr -radix hexadecimal /testbench/u_cpu/if_IMAddr
...
WaveRestoreCursors {{Cursor 1} {5064 ps} 0} {{Cursor 2} {6600 ps} 0} {{Cursor 3} {6800 ps} 0} {{Cursor 4} {7000 ps} 0} {{Cursor 5} {7210 ps} 0}
