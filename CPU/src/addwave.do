...
add wave -position end  sim:/testbench/u_cpu/u_Mux_ALU_A/ALUOut
...
add wave -position end  sim:/testbench/u_cpu/exe_ASrc4
add wave -position end  sim:/testbench/u_cpu/exe_BSrc4
