...
add wave -position end  sim:/testbench/u_cpu/exe_ASrc_o
add wave -position end  sim:/testbench/u_cpu/exe_BSrc_o
add wave -position end  sim:/testbench/u_cpu/exe_ASrc4_o
add wave -position end  sim:/testbench/u_cpu/exe_BSrc4_o
